...
##############################################################################
{
    'name': 'Chinese Chart of Accounts 中国会计科目表',
    'version': '1.8',
    ...
    Account Type \ chart of accounts template \ VAT \ auxiliary accounting category \ management accounting vouchers Book \ Financial Accounting vouchers Book

    添加中文省份数据 Add Chinese provinces data

    增加小企业会计科目表 Chart of Accounts to increase small business
